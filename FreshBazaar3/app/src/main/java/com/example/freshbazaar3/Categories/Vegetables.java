...
RecyclerView.LayoutManager layoutManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductRef= FirebaseDatabase.getInstance().getReference("Categories").child("Vegetables");
    }
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Items model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent intent = new Intent(Vegetables.this, ProductDisplayVegetables.class);
