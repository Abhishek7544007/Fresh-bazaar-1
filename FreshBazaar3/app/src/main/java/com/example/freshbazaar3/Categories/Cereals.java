...
import com.example.freshbazaar3.ProductDisplays.ProductDisplayCereal;
...
public class Cereals extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductRef = FirebaseDatabase.getInstance().getReference("Categories").child("Cereals");
    }
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Items model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent intent = new Intent(Cereals.this, ProductDisplayCereal.class);
