...
public class ProductDisplaySeafood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_display_seafood);
    ...
    private void getItemDetails(String productId) {
        ...
        DatabaseReference productref = FirebaseDatabase.getInstance().getReference("Categories").child("Seafood");
