...
public class ProductDisplayFruit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_display_fruit);
    ...
    private void getItemDetails(String productId) {
        ...
        DatabaseReference productref = FirebaseDatabase.getInstance().getReference("Categories").child("Fruit");
