...
public class product_deal extends AppCompatActivity {
   ...
   private void addingtocart(){
        ...
        cartref.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Product")
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            Toast.makeText(product_deal.this,"Added to cart",Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(product_deal.this, homepage2.class));
                        }
                    }
                });
    ...
    private void getItemDetails(String productId) {
        ...
        DatabaseReference productref = FirebaseDatabase.getInstance().getReference("Deal Of the day");
