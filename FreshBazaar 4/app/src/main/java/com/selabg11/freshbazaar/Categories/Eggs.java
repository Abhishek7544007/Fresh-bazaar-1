...
import com.selabg11.freshbazaar.ProductDisplays.ProductDisplayEggs;
...
public class Eggs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductRef = FirebaseDatabase.getInstance().getReference("Categories").child("Eggs");
    }
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Items model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent intent = new Intent(Eggs.this, ProductDisplayEggs.class);
